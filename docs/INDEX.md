...
| **四期** | **架构加固(Pipeline + EventBus + LLM 重试/流式 + 批量接口)** | ✅ R7 + R8 全部完成(10 项全清,539/539 passed,ruff 0;见 [handover-history/round_7_phase4_core.md](handover-history/round_7_phase4_core.md) + [round_8_phase4_fb.md](handover-history/round_8_phase4_fb.md)) |
